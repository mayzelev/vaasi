                            ...
                            <div>
                                ...
                                <div className={style.description}>
                                    ...
                                    <p className={style.subDescription2}>
                                        ...
                                        буде використовуватись під час входу до вашого особистого кабінету. <br /> Користування сайтом передбачає
                                        його оплату. Перед початком користування сайтом дізнайтеся інформацію у свого адміністратора.
                                        Реєстрація на порталі без коду адміністратора неможлива.
                                    </p>
                                </div>
                            </div>
                        </div>
